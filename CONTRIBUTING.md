# Contributing to aivolve

Thank you for your interest in contributing to aivolve! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/aivolve.git
   cd aivolve
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/aivolve.git
   ```
...
By contributing to aivolve, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
